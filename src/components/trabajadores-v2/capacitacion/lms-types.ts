...
export const CATALOGO_CAPACITACIONES: TrainingCatalogItem[] = [
  {
    ...
    quiz: [
      ...
      {
        id: "q2",
        prompt: "El IRL debe registrarse para:",
  ...
  },
  {
    id: "tr-004",
    codigo: "SST-IRL-004",
    nombre: "IRL y Control de Riesgos DS44",
    descripcion: "Aplicación práctica de Información de Riesgos Laborales y controles críticos por puesto.",
    categoria: "DS44",
    duracionMin: 45,
    vigenciaMeses: 24,
    modalidad: "elearning",
    videoUrl: "https://example.com/video/irl-ds44",
    materiales: ["Formato IRL", "Matriz de controles críticos"],
    requiereTest: false,
    requiereFirma: true,
    notaMinima: 0,
    generaCertificado: true,
