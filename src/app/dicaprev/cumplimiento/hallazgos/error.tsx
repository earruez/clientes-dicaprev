...
export default function HallazgosError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[hallazgos error]", error);
  }, [error]);
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-4 bg-slate-50 p-6">
      <div className="text-center max-w-md space-y-3">
        ...
        <h1 className="text-xl font-semibold text-slate-900">Error al cargar hallazgos</h1>
