...
import { calcularFechaExpiracion, generarTokenCambioContraseña } from "@/lib/password-reset";
  ...
  try {
    ...
    await prisma.$transaction([
      ...
      prisma.usuarioCambioContraseña.create({
        data: { usuarioId: usuario.id, token, expires: calcularFechaExpiracion(24) },
      }),
    ]);
    ...
    try {
      ...
      console.error(`Error enviando recuperación de contraseña a ${usuario.email}:`, error);
    }
