...
CREATE TABLE "RequisitoPlantillaAcreditacion" (
    ...
    "documentoRequeridoEmpresaId" TEXT,
    "documentoTipoTrabajadorId" TEXT,
...
-- AddForeignKey
ALTER TABLE "RequisitoPlantillaAcreditacion" ADD CONSTRAINT "RequisitoPlantillaAcreditacion_documentoRequeridoEmpresaId_fkey" FOREIGN KEY ("documentoRequeridoEmpresaId") REFERENCES "DocumentoRequeridoEmpresa"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RequisitoPlantillaAcreditacion" ADD CONSTRAINT "RequisitoPlantillaAcreditacion_documentoTipoTrabajadorId_fkey" FOREIGN KEY ("documentoTipoTrabajadorId") REFERENCES "DocumentoTipoTrabajador"("id") ON DELETE SET NULL ON UPDATE CASCADE;
